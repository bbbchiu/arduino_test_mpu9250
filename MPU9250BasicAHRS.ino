...
// Start device display with ID of sensor
  ...
  display.setCursor(0,0); display.print(F("MPU9250"));
  display.setTextSize(1);
  display.setCursor(0, 20); display.print(F("9-DOF 16-bit"));
  display.setCursor(0, 30); display.print(F("motion sensor"));
  display.setCursor(20,40); display.print(F("60 ug LSB"));
  display.display();
  delay(1000);
...
// Set up for data display
  ...
  Serial.print("MPU9250 "); Serial.print(F("I AM ")); Serial.print(c, HEX); Serial.print(F(" I should be ")); Serial.println(0x71, HEX);
  display.setCursor(20,0); display.print(F("MPU9250"));
  display.setCursor(0,10); display.print(F("I AM"));
  display.setCursor(0,20); display.print(c, HEX);  
  display.setCursor(0,30); display.print(F("I Should Be"));
  ...
  {  
    ...
    display.clearDisplay();
    display.setCursor(20,0); display.print(F("AK8963"));
    display.setCursor(0,10); display.print(F("I AM"));
  ...
  if(SerialDebug) {
    ...
    display.clearDisplay();
    display.setCursor(20,0); display.print(F("AK8963"));
    display.setCursor(0,10); display.print(F("ASAX ")); display.setCursor(50,10); display.print(magCalibration[0], 2);
    display.setCursor(0,20); display.print(F("ASAY ")); display.setCursor(50,20); display.print(magCalibration[1], 2);
    display.setCursor(0,30); display.print(F("ASAZ ")); display.setCursor(50,30); display.print(magCalibration[2], 2);
    display.display();
    delay(1000);  
  }
  else
